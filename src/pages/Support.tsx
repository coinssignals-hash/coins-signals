        ...
        <div className="relative px-4 py-4">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-xl flex items-center justify-center" style={{
              ...
              <Headphones className="w-5 h-5" style={{ color: 'hsl(200 80% 55%)' }} />
            </div>
            <div>
              <h1 className="text-lg font-bold text-foreground tracking-tight">{t('support_title')}</h1>
              <p className="text-[11px] text-muted-foreground">ID # {user?.id?.slice(0, 7) || '0572564'}</p>
            </div>
          </div>
        </div>
      </div>
