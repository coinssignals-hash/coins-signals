...
interface GlowSectionProps {
  ...
  color?: string;
  className?: string;
  /** Extra inline styles merged onto the wrapper (e.g. boxShadow) */
  style?: CSSProperties;
}

export const GlowSection = forwardRef<HTMLDivElement, GlowSectionProps>(
  ({ children, color = '210 70% 55%', className, style }, ref) => {
    return (
